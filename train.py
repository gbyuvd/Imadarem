...
# ====================================================
# 1. Setup (BEFORE any model imports)
# ====================================================
seed = 2025
...
# ====================================================
# 2. Dataset Class (PATCHED with lengths)
# ====================================================
    ...
    for epoch in range(epochs):
        ...
        with torch.no_grad():
            for batch, lengths in tqdm(test_loader, desc="Validating", leave=False):
                ...
                # Accuracy: only on first few batches (expensive)
                if acc_batches < 5:
                    ...
                    # Convert samples to tensor for comparison
                    sample_tensors = []
                    for s in samples:
...
if __name__ == "__main__":
    ...
    print("  ✅ Padding-aware corruption and loss")
    print("  ✅ Temperature control for sampling")
    print("  ✅ Length MAE tracking in validation")
    print("="*70)